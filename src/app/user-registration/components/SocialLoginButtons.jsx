  ...
  return (
    <div className="space-y-3">
      <button
        ...
        className="w-full flex items-center justify-center space-x-3 px-4 py-3 border-2 border-border rounded-lg hover:bg-muted transition-all duration-200 group"
      >
